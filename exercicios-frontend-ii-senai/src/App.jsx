...
import AdicionarNomes from "./paginas/AdicionarNome/AdicionarNome";
import RemoverNome from "./paginas/RemoverNome/RemoverNome";
...
const router = createBrowserRouter([
  ...
  {
    path: "botao-adicionar-nome", 
    element: <AdicionarNomes/>,
  },
  {
    path: "botao-remover-nome", 
    element: <RemoverNome/>,
  },
]);
