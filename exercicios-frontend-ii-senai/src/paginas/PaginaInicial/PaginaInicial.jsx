...
const PaginaInicial = () => {
    ...
    return <Principal titulo="Página Inicial">
        ...
        <BotaoCustomizado cor={'quinternario'} onClick={() => navigate('/botao-multiplicar')}>
            Questão 5
        </BotaoCustomizado>

        <div><h4>
            6. Crie um componente chamado Dividir que contém dois campos tipo numérico, e
            um botão "Dividir" que ao ser clicado deve multiplicar os dois valores e mostrar o
            resultado, conforme exemplo:

        </h4></div>
        <BotaoCustomizado cor={'sexternario'} onClick={() => navigate('/botao-dividir')}>
            Questão 6
        </BotaoCustomizado>
        ...
        <BotaoCustomizado cor={'seternario'} onClick={() => navigate('/botao-cambio-dolar')}>
            Questão 7
        </BotaoCustomizado>
