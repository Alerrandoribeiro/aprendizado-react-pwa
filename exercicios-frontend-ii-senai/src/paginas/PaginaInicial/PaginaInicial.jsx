...
const PaginaInicial = () => {
  ...
  return (
    <Principal titulo="Página Inicial">
      ...
      <div>
        <h4>
          10.Crie um componente chamado AdicionarNome que contém um campo do
          tipo texto e um botão "Adicionar" que ao ser clicado deve adicionar o
          nome digitado em uma lista e mostrar conforme exemplo:
        </h4>
      </div>
      <BotaoCustomizado
        cor={"ternario"}
        onClick={() => navigate("/botao-adicionar-nome")}
      >
        Questão 10
      </BotaoCustomizado>
      <div>
        <h4>
          11.Crie um componente chamado RemoverNome que contém uma lista de
          nomes com o botão "Remover" ao lado que ao ser clicado deve remover o
          respectivo nome da lista, conforme o exemplo:
        </h4>
      </div>
      <BotaoCustomizado
        cor={"onternario"}
        onClick={() => navigate("/botao-remover-nome")}
      >
        Questão 11
      </BotaoCustomizado>
    </Principal>
